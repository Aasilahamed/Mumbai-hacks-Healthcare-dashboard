...
export const EmergencySOS: React.FC = () => {
  ...
  const triggerEmergencyAlert = () => {
    ...
    if (location) {
      ...
      console.log(`Alert sent with location: ${location.lat}, ${location.lng}`);
    }
  };
            ...
            <div className="space-y-4">
                <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-xl p-6 animate-in fade-in slide-in-from-bottom-4">
                    ...
                    <div className="space-y-2">
                        <p className="text-emerald-600 dark:text-emerald-300 flex items-center gap-2">
                        ...
                        {location && (
                            <p className="text-emerald-600 dark:text-emerald-300 flex items-center gap-2 text-sm">
                ...
                <div className="flex justify-center">
                    <Button onClick={resetSOS} variant="secondary">
                        Reset SOS
                    </Button>
                </div>
            </div>
